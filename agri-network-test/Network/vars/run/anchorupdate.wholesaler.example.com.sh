...
export CORE_PEER_ADDRESS=192.168.0.103:7012
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/wholesaler.example.com/peers/peer1.wholesaler.example.com/tls/ca.crt
...
jq '.channel_group.groups.Application.groups."wholesaler-example-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.0.103","port": 7012}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
