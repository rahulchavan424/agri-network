...
export CORE_PEER_ADDRESS=192.168.0.103:7014
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/distributor.example.com/peers/peer1.distributor.example.com/tls/ca.crt
