...
export CORE_PEER_ADDRESS=192.168.0.103:7018
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/transporter.example.com/peers/peer1.transporter.example.com/tls/ca.crt
