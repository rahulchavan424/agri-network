...
jq '.channel_group.groups.Application.groups."distributor-example-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.0.103","port": 7015}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
